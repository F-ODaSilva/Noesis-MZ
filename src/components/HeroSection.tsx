        ...
        <div className="container mx-auto  py-32 relative z-30">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div ref={ctaRef} className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
              <Button
                className="hero-cta group hover:cursor-pointer"
            ...
            {/* Stats */}
            <div ref={statsRef} className="grid grid-cols-1 md:grid-cols-3 gap-1 max-w-2xl mx-auto ">
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-accent mb-1">500MW</div>
                <div className="text-sm text-muted-foreground">{t('hero.stats.capacity')}</div>
              </div>
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-accent mb-1">2025</div>
